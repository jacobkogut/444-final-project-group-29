...
/******************************************************************************/
#define AI_DECODER_MODEL_NAME          "decoder"
#define AI_DECODER_ORIGIN_MODEL_NAME   "decoder_fixed"

/******************************************************************************/
#define AI_DECODER_ACTIVATIONS_ALIGNMENT   (4)
#define AI_DECODER_INPUTS_IN_ACTIVATIONS   (4)
#define AI_DECODER_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_DECODER_IN_NUM        (1)

AI_DEPRECATED
#define AI_DECODER_IN \
  ai_decoder_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_DECODER_IN_SIZE { \
  AI_DECODER_IN_1_SIZE, \
}
#define AI_DECODER_IN_SIZE_BYTES { \
  AI_DECODER_IN_1_SIZE_BYTES, \
}
#define AI_DECODER_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_DECODER_IN_1_HEIGHT      (64)
#define AI_DECODER_IN_1_WIDTH       (32)
#define AI_DECODER_IN_1_CHANNEL     (1)
#define AI_DECODER_IN_1_SIZE        (2048)
#define AI_DECODER_IN_1_SIZE_BYTES  (8192)

/******************************************************************************/
#define AI_DECODER_OUT_NUM       (1)

AI_DEPRECATED
#define AI_DECODER_OUT \
  ai_decoder_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_DECODER_OUT_SIZE { \
  AI_DECODER_OUT_1_SIZE, \
}
#define AI_DECODER_OUT_SIZE_BYTES { \
  AI_DECODER_OUT_1_SIZE_BYTES, \
}
#define AI_DECODER_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_DECODER_OUT_1_HEIGHT      (1)
#define AI_DECODER_OUT_1_WIDTH       (512)
#define AI_DECODER_OUT_1_CHANNEL     (1)
#define AI_DECODER_OUT_1_SIZE        (512)
#define AI_DECODER_OUT_1_SIZE_BYTES  (2048)

/******************************************************************************/
#define AI_DECODER_N_NODES (18)
 ...
 * @ref ai_decoder_create. Both the activations memory buffer 
 ...
 * using @ref ai_decoder_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_decoder_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_decoder_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_DECODER_*
 * defines into file @ref decoder.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
