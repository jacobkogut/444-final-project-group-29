...
/******************************************************************************/
#define AI_ENCODER_MODEL_NAME          "encoder"
#define AI_ENCODER_ORIGIN_MODEL_NAME   "encoder_fixed"

/******************************************************************************/
#define AI_ENCODER_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ENCODER_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ENCODER_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ENCODER_IN_NUM        (1)

AI_DEPRECATED
#define AI_ENCODER_IN \
  ai_encoder_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ENCODER_IN_SIZE { \
  AI_ENCODER_IN_1_SIZE, \
}
#define AI_ENCODER_IN_SIZE_BYTES { \
  AI_ENCODER_IN_1_SIZE_BYTES, \
}
#define AI_ENCODER_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ENCODER_IN_1_HEIGHT      (1)
#define AI_ENCODER_IN_1_WIDTH       (512)
#define AI_ENCODER_IN_1_CHANNEL     (1)
#define AI_ENCODER_IN_1_SIZE        (512)
#define AI_ENCODER_IN_1_SIZE_BYTES  (2048)

/******************************************************************************/
#define AI_ENCODER_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ENCODER_OUT \
  ai_encoder_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ENCODER_OUT_SIZE { \
  AI_ENCODER_OUT_1_SIZE, \
}
#define AI_ENCODER_OUT_SIZE_BYTES { \
  AI_ENCODER_OUT_1_SIZE_BYTES, \
}
#define AI_ENCODER_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ENCODER_OUT_1_HEIGHT      (64)
#define AI_ENCODER_OUT_1_WIDTH       (32)
#define AI_ENCODER_OUT_1_CHANNEL     (1)
#define AI_ENCODER_OUT_1_SIZE        (2048)
#define AI_ENCODER_OUT_1_SIZE_BYTES  (8192)

/******************************************************************************/
#define AI_ENCODER_N_NODES (14)
 ...
 * @ref ai_encoder_create. Both the activations memory buffer 
 ...
 * using @ref ai_encoder_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_encoder_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_encoder_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ENCODER_*
 * defines into file @ref encoder.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
